...
#define CONFIGURATION_H_VERSION 20180616
...
#define STRING_CONFIG_H_AUTHOR "Kale" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "1.0" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Printer"         // will be shown during bootup in line 2
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 50, 5000 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ABL_PROBE_PT_2_Y 148 // iza
  
  #define ABL_PROBE_PT_3_X 165 //desno
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (X_MAX_LENGTH / 2)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT (Y_MAX_LENGTH / 2)    // Y point for Z homing when homing all axes (G28).
#endif
